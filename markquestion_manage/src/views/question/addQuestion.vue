<template>
  <div>
    <el-form label-position="right" label-width="50px">
      ...
      <el-button style="display: inline-block;margin-left: 10px;" type="primary" @click="submitSolution">发布题解</el-button>
    </el-form>
    <mavon-editor
...
export default {
  ...
  methods:{
    ...
    //在弹出框中点击提交
    submit(){
      questionApi.addQuestion(qs.stringify(this.question)).then(resp => {
        if(resp.code === 200){
